"""
Heavy evaluation: complex prompts, both languages, all paths.
...
Usage:
    uv run python -m tests.eval.heavy            # all groups
    uv run python -m tests.eval.heavy routing    # one group only
"""
