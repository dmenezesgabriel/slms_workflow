...
def _eval_summarization_guard() -> SummarizationGuardMetrics:
    from app.handlers.summarization import handle
...
def _eval_qa_proper_noun() -> QAProperNounMetrics:
    from app.handlers.question_answering import _PROPER_NOUN_RE, _WHAT_IS_RE
...
def main() -> None:
    ...
    if use_mlflow:
        ...
        print(f"    python -m tests.eval.compare\n")
